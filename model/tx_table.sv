module tx_table (
    ...
    always_comb begin
        ...
        row_hit       = '0;
        esd_ext_err_n     = (tx_error_n[0] && tx_error_n[1] && tx_error_n[2] && (TXD_n != 8'h0F)) ||
                            (tx_error_n[0] && tx_error_n[1] && tx_error_n[2] && tx_error_n[3] && (TXD_n != 8'h0F));
        ...
        row_hit[ROW_CSEXTEND]     = csreset_n       && tx_error_n[0]    && (TXD_n == 8'h0F);
        row_hit[ROW_CSEXTEND_ERR] = csreset_n       && tx_error_n[0]    && (TXD_n != 8'h0F);
        ...
        row_hit[ROW_ESD2_EXT_2]   = !tx_enable_n[3] && tx_enable_n[4]   && tx_error_n[0]    &&
                                    tx_error_n[1]   && tx_error_n[2]    && tx_error_n[3]    && (TXD_n == 8'h0F);
